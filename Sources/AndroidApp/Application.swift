...
@JavaClass("android.app.Application")
open class Application: JavaObject {
  @JavaMethod
  ...
  @JavaMethod
  open func registerOnProvideAssistDataListener(_ arg0: Application.OnProvideAssistDataListener?)

  @JavaMethod
  open func unregisterOnProvideAssistDataListener(_ arg0: Application.OnProvideAssistDataListener?)
}
extension JavaClass<Application> {
  ...
  @JavaStaticMethod
  public func getProcessName() -> String
}
