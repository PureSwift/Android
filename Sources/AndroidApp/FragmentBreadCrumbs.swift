...
@JavaClass("android.app.FragmentBreadCrumbs", implements: FragmentManager.OnBackStackChangedListener.self)
open class FragmentBreadCrumbs: JavaObject {
  @JavaMethod
  open func setTitle(_ arg0: CharSequence?, _ arg1: CharSequence?)

  @JavaMethod
  open func onBackStackChanged()

  @JavaMethod
  open func setActivity(_ arg0: Activity?)

  @JavaMethod
  open func setMaxVisible(_ arg0: Int32)

  @JavaMethod
  open func setParentTitle(_ arg0: CharSequence?, _ arg1: CharSequence?, _ arg2: FragmentBreadCrumbs.OnClickListener?)

  @JavaMethod
  open func setOnBreadCrumbClickListener(_ arg0: FragmentBreadCrumbs.OnBreadCrumbClickListener?)
...
extension JavaClass<FragmentBreadCrumbs.BaseSavedState> {
...
extension JavaClass<FragmentBreadCrumbs.MeasureSpec> {
  @JavaStaticField(isFinal: true)
...
extension JavaClass<FragmentBreadCrumbs.LayoutParams> {
  @JavaStaticField(isFinal: true)
...
extension FragmentBreadCrumbs {
  ...
  open class MarginLayoutParams: FragmentBreadCrumbs.LayoutParams {
  @JavaField(isFinal: false)
  ...
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: FragmentBreadCrumbs.MarginLayoutParams?, environment: JNIEnvironment? = nil)
...
extension JavaClass<FragmentBreadCrumbs.MarginLayoutParams> {
  @JavaStaticField(isFinal: true)
  public var FILL_PARENT: Int32
...
extension JavaClass<FragmentBreadCrumbs> {
  @JavaStaticField(isFinal: true)
