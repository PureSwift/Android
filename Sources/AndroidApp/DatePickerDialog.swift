...
@JavaClass("android.app.DatePickerDialog")
open class DatePickerDialog: AlertDialog {
  @JavaMethod
  open func setOnDateSetListener(_ arg0: DatePickerDialog.OnDateSetListener?)

  @JavaMethod
  open func updateDate(_ arg0: Int32, _ arg1: Int32, _ arg2: Int32)
}
extension JavaClass<DatePickerDialog> {
