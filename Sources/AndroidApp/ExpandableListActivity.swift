...
@JavaClass("android.app.ExpandableListActivity", implements: FragmentBreadCrumbs.OnCreateContextMenuListener.self)
open class ExpandableListActivity: Activity {
  @JavaMethod
  @_nonoverride public convenience init(environment: JNIEnvironment? = nil)

  @JavaMethod
  open func onGroupCollapse(_ arg0: Int32)

  @JavaMethod
  open func onGroupExpand(_ arg0: Int32)
  ...
  @JavaMethod
  open override func onContentChanged()
}
extension JavaClass<ExpandableListActivity> {
