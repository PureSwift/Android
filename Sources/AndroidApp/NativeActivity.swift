...
@JavaClass("android.app.NativeActivity")
open class NativeActivity: Activity {
  ...
  @JavaMethod
  open override func onLowMemory()
...
extension JavaClass<NativeActivity> {
  @JavaStaticField(isFinal: true)
  public var META_DATA_FUNC_NAME: String

  @JavaStaticField(isFinal: true)
  public var META_DATA_LIB_NAME: String
