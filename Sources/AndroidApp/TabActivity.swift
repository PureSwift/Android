...
@JavaClass("android.app.TabActivity")
open class TabActivity: ActivityGroup {
  @JavaMethod
  @_nonoverride public convenience init(environment: JNIEnvironment? = nil)

  @JavaMethod
  open func setDefaultTab(_ arg0: Int32)

  @JavaMethod
  open func setDefaultTab(_ arg0: String)

  @JavaMethod
  open override func onContentChanged()

  @JavaMethod
  open override func onChildTitleChanged(_ arg0: Activity?, _ arg1: CharSequence?)
}
extension JavaClass<TabActivity> {
