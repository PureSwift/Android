...
@JavaClass("android.app.LauncherActivity")
open class LauncherActivity: ListActivity {
  @JavaMethod
  ...
  @JavaMethod
  open override func setTitle(_ arg0: Int32)

  @JavaMethod
  open func onSetContentView()

  @JavaMethod
  open func itemForPosition(_ arg0: Int32) -> LauncherActivity.ListItem!

  @JavaMethod
  open func makeListItems() -> List<LauncherActivity.ListItem>!
}
extension JavaClass<LauncherActivity> {
