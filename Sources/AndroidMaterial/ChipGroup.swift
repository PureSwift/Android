...
open class ChipGroup: ViewGroup {
  ...
  @JavaMethod
  open override func setOnHierarchyChangeListener(_ arg0: ViewGroup.OnHierarchyChangeListener?)

  @JavaMethod
  open func setOnCheckedChangeListener(_ arg0: ChipGroup.OnCheckedChangeListener?)

  @JavaMethod
  open func isSingleSelection() -> Bool

  @JavaMethod
  open func setSingleSelection(_ arg0: Int32)

  @JavaMethod
  open func setSingleSelection(_ arg0: Bool)

  @JavaMethod
  open func setSelectionRequired(_ arg0: Bool)

  @JavaMethod
  open func isSelectionRequired() -> Bool
  ...
  @JavaMethod
  open func setDividerDrawableHorizontal(_ arg0: Drawable?)

  @JavaMethod
  open func setDividerDrawableVertical(_ arg0: Drawable?)

  @JavaMethod
  open func setShowDividerHorizontal(_ arg0: Int32)

  @JavaMethod
  open func setShowDividerVertical(_ arg0: Int32)

  @JavaMethod
  open func setFlexWrap(_ arg0: Int32)

  @JavaMethod
  open func getCheckedChipId() -> Int32

  @JavaMethod
  open func getCheckedChipIds() -> List<JavaInteger>!

  @JavaMethod
  open func clearCheck()

  @JavaMethod
  open func setOnCheckedStateChangeListener(_ arg0: ChipGroup.OnCheckedStateChangeListener?)

  @JavaMethod
  open func setChipSpacing(_ arg0: Int32)

  @JavaMethod
  open func setChipSpacingResource(_ arg0: Int32)

  @JavaMethod
  open func getChipSpacingHorizontal() -> Int32

  @JavaMethod
  open func setChipSpacingHorizontal(_ arg0: Int32)

  @JavaMethod
  open func setChipSpacingHorizontalResource(_ arg0: Int32)

  @JavaMethod
  open func getChipSpacingVertical() -> Int32

  @JavaMethod
  open func setChipSpacingVertical(_ arg0: Int32)

  @JavaMethod
  open func setChipSpacingVerticalResource(_ arg0: Int32)
  ...
  @JavaMethod
  open func setSingleLine(_ arg0: Int32)

  @JavaMethod
  open func check(_ arg0: Int32)
}
extension JavaClass<ChipGroup> {
