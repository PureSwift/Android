...
@JavaClass("com.google.android.material.appbar.CollapsingToolbarLayout")
open class CollapsingToolbarLayout: FrameLayout {
  ...
  @JavaMethod
  open override func onConfigurationChanged(_ arg0: Configuration?)
  ...
  @JavaMethod
  open func setTitleCollapseMode(_ arg0: Int32)

  @JavaMethod
  open func getTitleCollapseMode() -> Int32

  @JavaMethod
  open func setTitleEnabled(_ arg0: Bool)

  @JavaMethod
  open func isTitleEnabled() -> Bool

  @JavaMethod
  open func setScrimsShown(_ arg0: Bool, _ arg1: Bool)

  @JavaMethod
  open func setScrimsShown(_ arg0: Bool)

  @JavaMethod
  open func setContentScrim(_ arg0: Drawable?)

  @JavaMethod
  open func setContentScrimColor(_ arg0: Int32)

  @JavaMethod
  open func setContentScrimResource(_ arg0: Int32)

  @JavaMethod
  open func getContentScrim() -> Drawable!

  @JavaMethod
  open func setStatusBarScrim(_ arg0: Drawable?)

  @JavaMethod
  open func setStatusBarScrimColor(_ arg0: Int32)

  @JavaMethod
  open func setStatusBarScrimResource(_ arg0: Int32)

  @JavaMethod
  open func getStatusBarScrim() -> Drawable!

  @JavaMethod
  open func setCollapsedTitleTextAppearance(_ arg0: Int32)

  @JavaMethod
  open func setCollapsedTitleTextColor(_ arg0: ColorStateList?)

  @JavaMethod
  open func setCollapsedTitleTextColor(_ arg0: Int32)

  @JavaMethod
  open func setCollapsedTitleGravity(_ arg0: Int32)

  @JavaMethod
  open func getCollapsedTitleGravity() -> Int32

  @JavaMethod
  open func setExpandedTitleTextAppearance(_ arg0: Int32)

  @JavaMethod
  open func setExpandedTitleColor(_ arg0: Int32)

  @JavaMethod
  open func setExpandedTitleTextColor(_ arg0: ColorStateList?)

  @JavaMethod
  open func setExpandedTitleGravity(_ arg0: Int32)

  @JavaMethod
  open func getExpandedTitleGravity() -> Int32

  @JavaMethod
  open func setExpandedTitleTextSize(_ arg0: Float)

  @JavaMethod
  open func getExpandedTitleTextSize() -> Float

  @JavaMethod
  open func setCollapsedTitleTextSize(_ arg0: Float)

  @JavaMethod
  open func getCollapsedTitleTextSize() -> Float

  @JavaMethod
  open func setCollapsedTitleTypeface(_ arg0: Typeface?)

  @JavaMethod
  open func getCollapsedTitleTypeface() -> Typeface!

  @JavaMethod
  open func setExpandedTitleTypeface(_ arg0: Typeface?)

  @JavaMethod
  open func getExpandedTitleTypeface() -> Typeface!

  @JavaMethod
  open func setExpandedTitleMargin(_ arg0: Int32, _ arg1: Int32, _ arg2: Int32, _ arg3: Int32)

  @JavaMethod
  open func getExpandedTitleMarginStart() -> Int32

  @JavaMethod
  open func setExpandedTitleMarginStart(_ arg0: Int32)

  @JavaMethod
  open func getExpandedTitleMarginTop() -> Int32

  @JavaMethod
  open func setExpandedTitleMarginTop(_ arg0: Int32)

  @JavaMethod
  open func getExpandedTitleMarginEnd() -> Int32

  @JavaMethod
  open func setExpandedTitleMarginEnd(_ arg0: Int32)

  @JavaMethod
  open func getExpandedTitleMarginBottom() -> Int32

  @JavaMethod
  open func setExpandedTitleMarginBottom(_ arg0: Int32)

  @JavaMethod
  open func setLineSpacingAdd(_ arg0: Float)

  @JavaMethod
  open func getLineSpacingAdd() -> Float

  @JavaMethod
  open func setLineSpacingMultiplier(_ arg0: Float)
  ...
  @JavaMethod
  open func setStaticLayoutBuilderConfigurer(_ arg0: CollapsingToolbarLayout.StaticLayoutBuilderConfigurer?)

  @JavaMethod
  open func setRtlTextDirectionHeuristicsEnabled(_ arg0: Bool)

  @JavaMethod
  open func isRtlTextDirectionHeuristicsEnabled() -> Bool

  @JavaMethod
  open func setForceApplySystemWindowInsetTop(_ arg0: Bool)

  @JavaMethod
  open func isForceApplySystemWindowInsetTop() -> Bool

  @JavaMethod
  open func setExtraMultilineHeightEnabled(_ arg0: Bool)

  @JavaMethod
  open func isExtraMultilineHeightEnabled() -> Bool

  @JavaMethod
  open func setScrimVisibleHeightTrigger(_ arg0: Int32)

  @JavaMethod
  open func getScrimVisibleHeightTrigger() -> Int32

  @JavaMethod
  open func setScrimAnimationDuration(_ arg0: Int64)

  @JavaMethod
  open func getScrimAnimationDuration() -> Int64
}
extension JavaClass<CollapsingToolbarLayout> {
  @JavaStaticField(isFinal: true)
  public var TITLE_COLLAPSE_MODE_SCALE: Int32

  @JavaStaticField(isFinal: true)
  public var TITLE_COLLAPSE_MODE_FADE: Int32
