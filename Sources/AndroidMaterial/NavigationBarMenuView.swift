...
@JavaClass("com.google.android.material.navigation.NavigationBarMenuView")
open class NavigationBarMenuView: ViewGroup {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: Context?, environment: JNIEnvironment? = nil)

  @JavaMethod
  open func updateMenuView()

  @JavaMethod
  open func buildMenuView()

  @JavaMethod
  open func getSelectedItemId() -> Int32

  @JavaMethod
  open func getWindowAnimations() -> Int32

  @JavaMethod
  open func setIconTintList(_ arg0: ColorStateList?)

  @JavaMethod
  open func getIconTintList() -> ColorStateList!
  ...
  @JavaMethod
  open func setItemBackgroundRes(_ arg0: Int32)
  ...
  @JavaMethod
  open func getItemActiveIndicatorEnabled() -> Bool
  ...
  @JavaMethod
  open func isItemActiveIndicatorResizeable() -> Bool

  @JavaMethod
  open func setItemActiveIndicatorResizeable(_ arg0: Bool)
  ...
  @JavaMethod
  open func getItemBackgroundRes() -> Int32
  ...
  @JavaMethod
  open func createDefaultColorStateList(_ arg0: Int32) -> ColorStateList!

  @JavaMethod
  open func setPresenter(_ arg0: NavigationBarPresenter?)

  @JavaMethod
  open func isShifting(_ arg0: Int32, _ arg1: Int32) -> Bool

  @JavaMethod
  open func findItemView(_ arg0: Int32) -> NavigationBarItemView!

  @JavaMethod
  open func createNavigationBarItemView(_ arg0: Context?) -> NavigationBarItemView!

  @JavaMethod
  open func getSelectedItemPosition() -> Int32
}
extension JavaClass<NavigationBarMenuView> {
