...
@JavaClass("com.google.android.material.appbar.AppBarLayout") //, implements: CircularRevealCoordinatorLayout.AttachedBehavior.self)
open class AppBarLayout: LinearLayout {
  ...
  @JavaMethod
  open func setExpanded(_ arg0: Bool, _ arg1: Bool)

  @JavaMethod
  open func setExpanded(_ arg0: Bool)

  @JavaMethod
  open func getTotalScrollRange() -> Int32
  ...
  @JavaMethod
  open override func setOrientation(_ arg0: Int32)
  ...
  @JavaMethod
  open override func generateDefaultLayoutParams() -> AppBarLayout.LayoutParams!

  @JavaMethod
  open func generateLayoutParams(_ arg0: ViewGroup.LayoutParams?) -> AppBarLayout.LayoutParams!

  @JavaMethod
  open func generateLayoutParams(_ arg0: AttributeSet?) -> AppBarLayout.LayoutParams!
  ...
  @JavaMethod
  open func addOnOffsetChangedListener(_ arg0: AppBarLayout.OnOffsetChangedListener?)

  @JavaMethod
  open func addOnOffsetChangedListener(_ arg0: AppBarLayout.BaseOnOffsetChangedListener?)

  @JavaMethod
  open func removeOnOffsetChangedListener(_ arg0: AppBarLayout.BaseOnOffsetChangedListener?)

  @JavaMethod
  open func removeOnOffsetChangedListener(_ arg0: AppBarLayout.OnOffsetChangedListener?)

  @JavaMethod
  open func addLiftOnScrollListener(_ arg0: AppBarLayout.LiftOnScrollListener?)

  @JavaMethod
  open func removeLiftOnScrollListener(_ arg0: AppBarLayout.LiftOnScrollListener?) -> Bool

  @JavaMethod
  open func clearLiftOnScrollListener()

  @JavaMethod
  open func setStatusBarForeground(_ arg0: Drawable?)

  @JavaMethod
  open func setStatusBarForegroundColor(_ arg0: Int32)

  @JavaMethod
  open func setStatusBarForegroundResource(_ arg0: Int32)

  @JavaMethod
  open func getStatusBarForeground() -> Drawable!

  @JavaMethod
  open func setLiftable(_ arg0: Bool) -> Bool

  @JavaMethod
  open func setLiftableOverrideEnabled(_ arg0: Bool)

  @JavaMethod
  open func setLifted(_ arg0: Bool) -> Bool

  @JavaMethod
  open func isLifted() -> Bool

  @JavaMethod
  open func setLiftOnScroll(_ arg0: Bool)

  @JavaMethod
  open func setLiftOnScrollTargetView(_ arg0: View?)

  @JavaMethod
  open func setLiftOnScrollTargetViewId(_ arg0: Int32)

  @JavaMethod
  open func getLiftOnScrollTargetViewId() -> Int32

  @JavaMethod
  open func setTargetElevation(_ arg0: Float)

  @JavaMethod
  open func getTargetElevation() -> Float
}
extension JavaClass<AppBarLayout> {
  @JavaStaticField(isFinal: true)
  public var HORIZONTAL: Int32

  @JavaStaticField(isFinal: true)
  public var SHOW_DIVIDER_BEGINNING: Int32

  @JavaStaticField(isFinal: true)
  public var SHOW_DIVIDER_END: Int32

  @JavaStaticField(isFinal: true)
  public var SHOW_DIVIDER_MIDDLE: Int32

  @JavaStaticField(isFinal: true)
  public var SHOW_DIVIDER_NONE: Int32
