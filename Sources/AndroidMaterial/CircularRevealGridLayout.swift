...
@JavaClass("com.google.android.material.circularreveal.CircularRevealGridLayout", implements: CircularRevealWidget.self)
open class CircularRevealGridLayout: GridLayout {
  @JavaMethod
