...
@JavaClass("com.google.android.material.navigationrail.NavigationRailMenuView")
open class NavigationRailMenuView: NavigationBarMenuView {
  @JavaMethod
...
extension JavaClass<NavigationRailMenuView> {
