...
@JavaClass("com.google.android.material.navigationrail.NavigationRailItemView")
open class NavigationRailItemView: NavigationBarItemView {
  @JavaMethod
...
extension JavaClass<NavigationRailItemView> {
