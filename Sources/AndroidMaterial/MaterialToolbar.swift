...
open class MaterialToolbar: ViewGroup {
  @JavaMethod
  ...
  @JavaMethod
  open func getLogoScaleType() -> ImageView.ScaleType!

  @JavaMethod
  open func setLogoScaleType(_ arg0: ImageView.ScaleType?)

  @JavaMethod
  open func isLogoAdjustViewBounds() -> Bool

  @JavaMethod
  open func setLogoAdjustViewBounds(_ arg0: Bool)
  ...
  @JavaMethod
  open func clearNavigationIconTint()

  @JavaMethod
  open func getNavigationIconTint() -> JavaInteger!

  @JavaMethod
  open func setTitleCentered(_ arg0: Bool)

  @JavaMethod
  open func isTitleCentered() -> Bool

  @JavaMethod
  open func setSubtitleCentered(_ arg0: Bool)

  @JavaMethod
  open func isSubtitleCentered() -> Bool
...
extension MaterialToolbar {
  @JavaClass("androidx.appcompat.widget.Toolbar$LayoutParams")
  ...
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: MaterialToolbar.LayoutParams?, environment: JNIEnvironment? = nil)
  }
}
extension JavaClass<MaterialToolbar.LayoutParams> {
...
extension MaterialToolbar {
  @JavaInterface("androidx.appcompat.widget.Toolbar$OnMenuItemClickListener")
...
extension MaterialToolbar {
  @JavaClass("androidx.appcompat.widget.Toolbar$SavedState")
...
extension JavaClass<MaterialToolbar.SavedState> {
  @JavaStaticField(isFinal: true)
  public var CREATOR: Parcelable.Creator<MaterialToolbar.SavedState>!
...
extension JavaClass<MaterialToolbar> {
  @JavaStaticField(isFinal: true)
