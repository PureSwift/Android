...
@JavaClass("com.google.android.material.checkbox.MaterialCheckBox")
open class MaterialCheckBox: CheckBox {
  @JavaMethod
  ...
  @JavaMethod
  open override func isChecked() -> Bool
  ...
  @JavaMethod
  open func setCheckedState(_ arg0: Int32)

  @JavaMethod
  open func getCheckedState() -> Int32

  @JavaMethod
  open func addOnCheckedStateChangedListener(_ arg0: MaterialCheckBox.OnCheckedStateChangedListener?)

  @JavaMethod
  open func removeOnCheckedStateChangedListener(_ arg0: MaterialCheckBox.OnCheckedStateChangedListener?)

  @JavaMethod
  open func clearOnCheckedStateChangedListeners()

  @JavaMethod
  open func setErrorShown(_ arg0: Bool)

  @JavaMethod
  open func isErrorShown() -> Bool

  @JavaMethod
  open func setErrorAccessibilityLabelResource(_ arg0: Int32)

  @JavaMethod
  open func setErrorAccessibilityLabel(_ arg0: CharSequence?)
  ...
  @JavaMethod
  open func setButtonIconDrawable(_ arg0: Drawable?)

  @JavaMethod
  open func getButtonIconDrawable() -> Drawable!

  @JavaMethod
  open func setButtonIconTintList(_ arg0: ColorStateList?)

  @JavaMethod
  open func getButtonIconTintList() -> ColorStateList!

  @JavaMethod
  open func setButtonIconTintMode(_ arg0: PorterDuff.Mode?)

  @JavaMethod
  open func getButtonIconTintMode() -> PorterDuff.Mode!

  @JavaMethod
  open func setUseMaterialThemeColors(_ arg0: Bool)

  @JavaMethod
  open func isUseMaterialThemeColors() -> Bool

  @JavaMethod
  open func setCenterIfNoTextEnabled(_ arg0: Bool)

  @JavaMethod
  open func isCenterIfNoTextEnabled() -> Bool
...
extension JavaClass<MaterialCheckBox> {
  @JavaStaticField(isFinal: true)
  public var STATE_UNCHECKED: Int32

  @JavaStaticField(isFinal: true)
  public var STATE_CHECKED: Int32

  @JavaStaticField(isFinal: true)
  public var STATE_INDETERMINATE: Int32
