...
@JavaClass("com.google.android.material.navigation.NavigationBarView")
open class NavigationBarView: FrameLayout {
  ...
  @JavaMethod
  open func removeBadge(_ arg0: Int32)

  @JavaMethod
  open func setOnItemSelectedListener(_ arg0: NavigationBarView.OnItemSelectedListener?)

  @JavaMethod
  open func setOnItemReselectedListener(_ arg0: NavigationBarView.OnItemReselectedListener?)

  @JavaMethod
  open func getMenu() -> Menu!

  @JavaMethod
  open func inflateMenu(_ arg0: Int32)

  @JavaMethod
  open func getItemIconTintList() -> ColorStateList!

  @JavaMethod
  open func setItemIconTintList(_ arg0: ColorStateList?)

  @JavaMethod
  open func setItemIconSize(_ arg0: Int32)

  @JavaMethod
  open func setItemIconSizeRes(_ arg0: Int32)

  @JavaMethod
  open func getItemIconSize() -> Int32

  @JavaMethod
  open func getItemTextColor() -> ColorStateList!

  @JavaMethod
  open func setItemTextColor(_ arg0: ColorStateList?)

  @JavaMethod
  open func getItemBackgroundResource() -> Int32

  @JavaMethod
  open func setItemBackgroundResource(_ arg0: Int32)

  @JavaMethod
  open func getItemBackground() -> Drawable!

  @JavaMethod
  open func setItemBackground(_ arg0: Drawable?)

  @JavaMethod
  open func getItemRippleColor() -> ColorStateList!

  @JavaMethod
  open func setItemRippleColor(_ arg0: ColorStateList?)

  @JavaMethod
  open func getItemPaddingTop() -> Int32

  @JavaMethod
  open func setItemPaddingTop(_ arg0: Int32)

  @JavaMethod
  open func getItemPaddingBottom() -> Int32

  @JavaMethod
  open func setItemPaddingBottom(_ arg0: Int32)

  @JavaMethod
  open func setActiveIndicatorLabelPadding(_ arg0: Int32)

  @JavaMethod
  open func getActiveIndicatorLabelPadding() -> Int32

  @JavaMethod
  open func isItemActiveIndicatorEnabled() -> Bool

  @JavaMethod
  open func setItemActiveIndicatorEnabled(_ arg0: Bool)

  @JavaMethod
  open func getItemActiveIndicatorWidth() -> Int32

  @JavaMethod
  open func setItemActiveIndicatorWidth(_ arg0: Int32)

  @JavaMethod
  open func getItemActiveIndicatorHeight() -> Int32

  @JavaMethod
  open func setItemActiveIndicatorHeight(_ arg0: Int32)

  @JavaMethod
  open func getItemActiveIndicatorMarginHorizontal() -> Int32

  @JavaMethod
  open func setItemActiveIndicatorMarginHorizontal(_ arg0: Int32)

  @JavaMethod
  open func getItemActiveIndicatorColor() -> ColorStateList!

  @JavaMethod
  open func setItemActiveIndicatorColor(_ arg0: ColorStateList?)

  @JavaMethod
  open func getSelectedItemId() -> Int32

  @JavaMethod
  open func setSelectedItemId(_ arg0: Int32)

  @JavaMethod
  open func setLabelVisibilityMode(_ arg0: Int32)

  @JavaMethod
  open func getLabelVisibilityMode() -> Int32

  @JavaMethod
  open func setItemTextAppearanceInactive(_ arg0: Int32)

  @JavaMethod
  open func getItemTextAppearanceInactive() -> Int32

  @JavaMethod
  open func setItemTextAppearanceActive(_ arg0: Int32)

  @JavaMethod
  open func setItemTextAppearanceActiveBoldEnabled(_ arg0: Bool)

  @JavaMethod
  open func getItemTextAppearanceActive() -> Int32

  @JavaMethod
  open func setItemOnTouchListener(_ arg0: Int32, _ arg1: View.OnTouchListener?)

  @JavaMethod
  open func getMaxItemCount() -> Int32

  @JavaMethod
  open func createNavigationBarMenuView(_ arg0: Context?) -> NavigationBarMenuView!

  @JavaMethod
  open func getPresenter() -> NavigationBarPresenter!
...
extension JavaClass<NavigationBarView> {
  @JavaStaticField(isFinal: true)
  public var LABEL_VISIBILITY_AUTO: Int32

  @JavaStaticField(isFinal: true)
  public var LABEL_VISIBILITY_SELECTED: Int32

  @JavaStaticField(isFinal: true)
  public var LABEL_VISIBILITY_LABELED: Int32

  @JavaStaticField(isFinal: true)
  public var LABEL_VISIBILITY_UNLABELED: Int32
