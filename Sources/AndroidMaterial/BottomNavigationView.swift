...
open class BottomNavigationView: NavigationBarView {
  ...
  @JavaMethod
  open override func createNavigationBarMenuView(_ arg0: Context?) -> NavigationBarMenuView!

  @JavaMethod
  open func setItemHorizontalTranslationEnabled(_ arg0: Bool)

  @JavaMethod
  open func isItemHorizontalTranslationEnabled() -> Bool

  @JavaMethod
  open func setOnNavigationItemSelectedListener(_ arg0: BottomNavigationView.OnNavigationItemSelectedListener?)

  @JavaMethod
  open func setOnNavigationItemReselectedListener(_ arg0: BottomNavigationView.OnNavigationItemReselectedListener?)
}
extension JavaClass<BottomNavigationView> {
