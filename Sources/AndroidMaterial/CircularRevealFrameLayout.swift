...
@JavaClass("com.google.android.material.circularreveal.CircularRevealFrameLayout", implements: CircularRevealWidget.self)
open class CircularRevealFrameLayout: FrameLayout {
  @JavaMethod
...
extension JavaClass<CircularRevealFrameLayout> {
