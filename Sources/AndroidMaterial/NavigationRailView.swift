...
@JavaClass("com.google.android.material.navigationrail.NavigationRailView")
open class NavigationRailView: NavigationBarView {
  ...
  @JavaMethod
  open func addHeaderView(_ arg0: View?)

  @JavaMethod
  open func addHeaderView(_ arg0: Int32)

  @JavaMethod
  open func removeHeaderView()

  @JavaMethod
  open override func createNavigationBarMenuView(_ arg0: Context?) -> NavigationRailMenuView!
  ...
  @JavaMethod
  open func setMenuGravity(_ arg0: Int32)

  @JavaMethod
  open func getMenuGravity() -> Int32

  @JavaMethod
  open func setItemMinimumHeight(_ arg0: Int32)

  @JavaMethod
  open func getItemMinimumHeight() -> Int32

  @JavaMethod
  open override func getMaxItemCount() -> Int32

  @JavaMethod
  open func getHeaderView() -> View!
}
extension JavaClass<NavigationRailView> {
