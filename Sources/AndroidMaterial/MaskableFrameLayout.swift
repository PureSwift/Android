...
@JavaClass("com.google.android.material.carousel.MaskableFrameLayout", implements: Maskable.self)
open class MaskableFrameLayout: FrameLayout {
  @JavaMethod
  ...
  @JavaMethod
  open func setMaskXPercentage(_ arg0: Float)

  @JavaMethod
  open func setMaskRectF(_ arg0: RectF?)

  @JavaMethod
  open func getMaskXPercentage() -> Float

  @JavaMethod
  open func getMaskRectF() -> RectF!

  @JavaMethod
  open func setOnMaskChangedListener(_ arg0: OnMaskChangedListener?)

  @JavaMethod
  open func setForceCompatClipping(_ arg0: Bool)
...
extension JavaClass<MaskableFrameLayout> {
