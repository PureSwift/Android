...
open class NavigationBarItemView: FrameLayout {
  ...
  @JavaMethod
  open func getItemPosition() -> Int32

  @JavaMethod
  open func setTitle(_ arg0: CharSequence?)

  @JavaMethod
  open func setShortcut(_ arg0: Bool, _ arg1: UInt16)

  @JavaMethod
  open func prefersCondensedTitle() -> Bool

  @JavaMethod
  open func showsIcon() -> Bool

  @JavaMethod
  open func getActiveIndicatorDrawable() -> Drawable!

  @JavaMethod
  open func getItemBackgroundResId() -> Int32

  @JavaMethod
  open func getItemDefaultMarginResId() -> Int32

  @JavaMethod
  open func getItemLayoutResId() -> Int32
  ...
  @JavaMethod
  open override func getSuggestedMinimumHeight() -> Int32

  @JavaMethod
  open override func getSuggestedMinimumWidth() -> Int32
  ...
  @JavaMethod
  open func setItemBackground(_ arg0: Int32)
  ...
  @JavaMethod
  open func setTextAppearanceInactive(_ arg0: Int32)

  @JavaMethod
  open func setTextAppearanceActive(_ arg0: Int32)

  @JavaMethod
  open func setTextAppearanceActiveBoldEnabled(_ arg0: Bool)

  @JavaMethod
  open func setActiveIndicatorEnabled(_ arg0: Bool)

  @JavaMethod
  open func setActiveIndicatorWidth(_ arg0: Int32)

  @JavaMethod
  open func setActiveIndicatorHeight(_ arg0: Int32)

  @JavaMethod
  open func setActiveIndicatorMarginHorizontal(_ arg0: Int32)

  @JavaMethod
  open func setActiveIndicatorDrawable(_ arg0: Drawable?)

  @JavaMethod
  open func setActiveIndicatorResizeable(_ arg0: Bool)

  @JavaMethod
  open func setCheckable(_ arg0: Bool)

  @JavaMethod
  open func setShifting(_ arg0: Bool)

  @JavaMethod
  open func setItemPosition(_ arg0: Int32)
...
extension JavaClass<NavigationBarItemView> {
