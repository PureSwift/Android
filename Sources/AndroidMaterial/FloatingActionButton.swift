...
open class FloatingActionButton: ImageButton {
  ...
  @JavaMethod
  open override func setScaleX(_ arg0: Float)

  @JavaMethod
  open override func setScaleY(_ arg0: Float)

  @JavaMethod
  open func setImageDrawable(_ arg0: Drawable?)
  ...
  @JavaMethod
  open override func setTranslationX(_ arg0: Float)

  @JavaMethod
  open override func setTranslationY(_ arg0: Float)

  @JavaMethod
  open override func setTranslationZ(_ arg0: Float)
  ...
  @JavaMethod
  open func show(_ arg0: FloatingActionButton.OnVisibilityChangedListener?)

  @JavaMethod
  open func show()

  @JavaMethod
  open func setUseCompatPadding(_ arg0: Bool)

  @JavaMethod
  open func setRippleColor(_ arg0: Int32)

  @JavaMethod
  open func setRippleColor(_ arg0: ColorStateList?)

  @JavaMethod
  open func getRippleColor() -> Int32

  @JavaMethod
  open func getUseCompatPadding() -> Bool
  ...
  @JavaMethod
  open func setSupportImageTintList(_ arg0: ColorStateList?)

  @JavaMethod
  open func getSupportImageTintList() -> ColorStateList!

  @JavaMethod
  open func setSupportImageTintMode(_ arg0: PorterDuff.Mode?)

  @JavaMethod
  open func getSupportImageTintMode() -> PorterDuff.Mode!

  @JavaMethod
  open override func setImageResource(_ arg0: Int32)
  ...
  @JavaMethod
  open func setMaxImageSize(_ arg0: Int32)

  @JavaMethod
  open func hide()

  @JavaMethod
  open func hide(_ arg0: FloatingActionButton.OnVisibilityChangedListener?)

  @JavaMethod
  open func isOrWillBeHidden() -> Bool

  @JavaMethod
  open func isOrWillBeShown() -> Bool

  @JavaMethod
  open func setCustomSize(_ arg0: Int32)

  @JavaMethod
  open func getCustomSize() -> Int32

  @JavaMethod
  open func clearCustomSize()

  @JavaMethod
  open func getContentRect(_ arg0: Rect?) -> Bool

  @JavaMethod
  open func getMeasuredContentRect(_ arg0: Rect?)

  @JavaMethod
  open func getContentBackground() -> Drawable!

  @JavaMethod
  open func getCompatElevation() -> Float

  @JavaMethod
  open func setCompatElevation(_ arg0: Float)

  @JavaMethod
  open func setCompatElevationResource(_ arg0: Int32)

  @JavaMethod
  open func getCompatHoveredFocusedTranslationZ() -> Float

  @JavaMethod
  open func setCompatHoveredFocusedTranslationZ(_ arg0: Float)

  @JavaMethod
  open func setCompatHoveredFocusedTranslationZResource(_ arg0: Int32)

  @JavaMethod
  open func getCompatPressedTranslationZ() -> Float

  @JavaMethod
  open func setCompatPressedTranslationZ(_ arg0: Float)

  @JavaMethod
  open func setCompatPressedTranslationZResource(_ arg0: Int32)
  ...
  @JavaMethod
  open func setSize(_ arg0: Int32)
}
extension JavaClass<FloatingActionButton> {
  @JavaStaticField(isFinal: true)
  public var SIZE_MINI: Int32

  @JavaStaticField(isFinal: true)
  public var SIZE_NORMAL: Int32

  @JavaStaticField(isFinal: true)
  public var SIZE_AUTO: Int32

  @JavaStaticField(isFinal: true)
  public var NO_CUSTOM_SIZE: Int32
