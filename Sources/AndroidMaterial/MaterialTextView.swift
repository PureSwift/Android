...
@JavaClass("com.google.android.material.textview.MaterialTextView")
open class MaterialTextView: TextView {
  @JavaMethod
  ...
  @JavaMethod
  open override func setLineHeight(_ arg0: Int32)
}
extension JavaClass<MaterialTextView> {
