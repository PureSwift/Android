...
open class BottomAppBar: ViewGroup {
  ...
  @JavaMethod
  open func setNavigationIcon(_ arg0: Drawable?)

  @JavaMethod
  open func setNavigationIconTint(_ arg0: Int32)

  @JavaMethod
  open func getFabAlignmentMode() -> Int32

  @JavaMethod
  open func setFabAlignmentMode(_ arg0: Int32)

  @JavaMethod
  open func setFabAlignmentModeAndReplaceMenu(_ arg0: Int32, _ arg1: Int32)

  @JavaMethod
  open func getFabAnchorMode() -> Int32

  @JavaMethod
  open func setFabAnchorMode(_ arg0: Int32)

  @JavaMethod
  open func getFabAnimationMode() -> Int32

  @JavaMethod
  open func setFabAnimationMode(_ arg0: Int32)

  @JavaMethod
  open func setMenuAlignmentMode(_ arg0: Int32)

  @JavaMethod
  open func getMenuAlignmentMode() -> Int32

  @JavaMethod
  open func setBackgroundTint(_ arg0: ColorStateList?)

  @JavaMethod
  open func getBackgroundTint() -> ColorStateList!

  @JavaMethod
  open func getFabCradleMargin() -> Float

  @JavaMethod
  open func setFabCradleMargin(_ arg0: Float)

  @JavaMethod
  open func getFabCradleRoundedCornerRadius() -> Float

  @JavaMethod
  open func setFabCradleRoundedCornerRadius(_ arg0: Float)

  @JavaMethod
  open func getCradleVerticalOffset() -> Float

  @JavaMethod
  open func setCradleVerticalOffset(_ arg0: Float)

  @JavaMethod
  open func getFabAlignmentModeEndMargin() -> Int32

  @JavaMethod
  open func setFabAlignmentModeEndMargin(_ arg0: Int32)

  @JavaMethod
  open func getHideOnScroll() -> Bool

  @JavaMethod
  open func setHideOnScroll(_ arg0: Bool)

  @JavaMethod
  open func performHide()

  @JavaMethod
  open func performHide(_ arg0: Bool)

  @JavaMethod
  open func performShow()

  @JavaMethod
  open func performShow(_ arg0: Bool)
  ...
  @JavaMethod
  open func replaceMenu(_ arg0: Int32)
  ...
  @JavaMethod
  open func getBehavior() -> BottomAppBar.Behavior!
}

extension JavaClass<BottomAppBar> {
  @JavaStaticField(isFinal: true)
  public var FAB_ALIGNMENT_MODE_CENTER: Int32

  @JavaStaticField(isFinal: true)
  public var FAB_ALIGNMENT_MODE_END: Int32

  @JavaStaticField(isFinal: true)
  public var FAB_ANCHOR_MODE_EMBED: Int32

  @JavaStaticField(isFinal: true)
  public var FAB_ANCHOR_MODE_CRADLE: Int32

  @JavaStaticField(isFinal: true)
  public var FAB_ANIMATION_MODE_SCALE: Int32

  @JavaStaticField(isFinal: true)
  public var FAB_ANIMATION_MODE_SLIDE: Int32

  @JavaStaticField(isFinal: true)
  public var MENU_ALIGNMENT_MODE_AUTO: Int32

  @JavaStaticField(isFinal: true)
  public var MENU_ALIGNMENT_MODE_START: Int32
