...
@JavaClass("com.google.android.material.bottomnavigation.BottomNavigationItemView")
open class BottomNavigationItemView: NavigationBarItemView {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: Context?, environment: JNIEnvironment? = nil)

  @JavaMethod
  open override func getItemDefaultMarginResId() -> Int32

  @JavaMethod
  open override func getItemLayoutResId() -> Int32
}
extension JavaClass<BottomNavigationItemView> {
