...
@JavaClass("com.google.android.material.bottomnavigation.BottomNavigationMenuView")
open class BottomNavigationMenuView: NavigationBarMenuView {
  @JavaMethod
  ...
  @JavaMethod
  open override func createNavigationBarItemView(_ arg0: Context?) -> NavigationBarItemView!
...
extension JavaClass<BottomNavigationMenuView> {
