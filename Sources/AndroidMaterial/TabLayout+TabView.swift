...
extension TabLayout {
  @JavaClass("com.google.android.material.tabs.TabLayout$TabView")
  open class TabView: LinearLayout {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: TabLayout?, _ arg1: Context?, environment: JNIEnvironment? = nil)
  ...
  @JavaMethod
  open func getTab() -> TabLayout.Tab!
  }
}
extension JavaClass<TabLayout.TabView> {
