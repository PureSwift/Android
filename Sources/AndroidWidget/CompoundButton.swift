...
@JavaClass("android.widget.CompoundButton", implements: Checkable.self)
open class CompoundButton: Button {
  @JavaMethod
  open override func drawableHotspotChanged(_ arg0: Float, _ arg1: Float)

  @JavaMethod
  open func setOnCheckedChangeListener(_ arg0: CompoundButton.OnCheckedChangeListener?)
...
extension JavaClass<CompoundButton> {
