...
@JavaClass("android.widget.AdapterViewAnimator", implements: Advanceable.self)
open class AdapterViewAnimator: AdapterView {
  ...
  @JavaMethod
  open func fyiWillBeAdvancedByHostKThx()

  @JavaMethod
  open override func getAccessibilityClassName() -> CharSequence!

  @JavaMethod
  open func setAnimateFirstView(_ arg0: Bool)
  ...
  @JavaMethod
  open func setDisplayedChild(_ arg0: Int32)

  @JavaMethod
  open func getDisplayedChild() -> Int32
...
extension JavaClass<AdapterViewAnimator> {
