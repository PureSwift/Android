...
@JavaClass("android.widget.AbsSpinner")
open class AbsSpinner: AdapterView {
  @JavaMethod
  open override func getCount() -> Int32

  @JavaMethod
  open func getAdapter() -> SpinnerAdapter!
  ...
  @JavaMethod
  open func setSelection(_ arg0: Int32, _ arg1: Bool)
