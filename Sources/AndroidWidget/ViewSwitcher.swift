...
@JavaClass("android.widget.ViewSwitcher")
open class ViewSwitcher: ViewAnimator {
  ...
  @JavaMethod
  open func setFactory(_ arg0: ViewSwitcher.ViewFactory?)
}
...
extension JavaClass<ViewSwitcher.BaseSavedState> {
...
extension JavaClass<ViewSwitcher.MeasureSpec> {
  @JavaStaticField(isFinal: true)
...
extension JavaClass<ViewSwitcher.LayoutParams> {
  @JavaStaticField(isFinal: true)
...
extension ViewSwitcher {
  ...
  open class MarginLayoutParams: ViewSwitcher.LayoutParams {
  @JavaField(isFinal: false)
...
extension JavaClass<ViewSwitcher.MarginLayoutParams> {
  @JavaStaticField(isFinal: true)
  public var FILL_PARENT: Int32
...
extension JavaClass<ViewSwitcher> {
  @JavaStaticField(isFinal: true)
