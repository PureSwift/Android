...
@JavaClass("android.widget.TabHost")
open class TabHost: FrameLayout {
  ...
  @JavaMethod
  open func newTabSpec(_ arg0: String) -> TabHost.TabSpec!

  @JavaMethod
  open func onTouchModeChanged(_ arg0: Bool)

  @JavaMethod
  open func addTab(_ arg0: TabHost.TabSpec?)

  @JavaMethod
  open func clearAllTabs()

  @JavaMethod
  open func getTabWidget() -> TabWidget!

  @JavaMethod
  open func getCurrentTab() -> Int32

  @JavaMethod
  open func getCurrentTabTag() -> String

  @JavaMethod
  open func setCurrentTabByTag(_ arg0: String)

  @JavaMethod
  open func getTabContentView() -> FrameLayout!

  @JavaMethod
  open func setCurrentTab(_ arg0: Int32)
}
extension JavaClass<TabHost> {
