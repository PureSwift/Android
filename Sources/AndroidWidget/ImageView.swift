...
open class ImageView: JavaObject {
  @JavaMethod
  ...
  @JavaMethod
  open func getAdjustViewBounds() -> Bool

  @JavaMethod
  open func setAdjustViewBounds(_ arg0: Bool)

  @JavaMethod
  open func setBaselineAlignBottom(_ arg0: Bool)

  @JavaMethod
  open func getBaselineAlignBottom() -> Bool
  ...
  @JavaMethod
  open func setImageResource(_ arg0: Int32)

  @JavaMethod
  open func setImageState(_ arg0: [Int32], _ arg1: Bool)

  @JavaMethod
  open func setImageLevel(_ arg0: Int32)

  @JavaMethod
  open func setScaleType(_ arg0: ImageView.ScaleType?)

  @JavaMethod
  open func getScaleType() -> ImageView.ScaleType!

  @JavaMethod
  open func getCropToPadding() -> Bool

  @JavaMethod
  open func setCropToPadding(_ arg0: Bool)

  @JavaMethod
  open func setBaseline(_ arg0: Int32)

  @JavaMethod
  open func setColorFilter(_ arg0: Int32)

  @JavaMethod
  open func clearColorFilter()

  @JavaMethod
  open func getImageAlpha() -> Int32

  @JavaMethod
  open func setImageAlpha(_ arg0: Int32)
