...
@JavaClass("android.widget.Chronometer")
open class Chronometer: TextView {
  ...
  @JavaMethod
  open func setFormat(_ arg0: String)
  ...
  @JavaMethod
  open func isTheFinalCountDown() -> Bool

  @JavaMethod
  open func setOnChronometerTickListener(_ arg0: Chronometer.OnChronometerTickListener?)

  @JavaMethod
  open func getOnChronometerTickListener() -> Chronometer.OnChronometerTickListener!

  @JavaMethod
  open func setCountDown(_ arg0: Bool)

  @JavaMethod
  open func setBase(_ arg0: Int64)

  @JavaMethod
  open func isCountDown() -> Bool
}
extension JavaClass<Chronometer> {
