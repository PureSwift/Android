...
@JavaClass("android.widget.SearchView")
open class SearchView: LinearLayout {
  ...
  @JavaMethod
  open func setOnQueryTextListener(_ arg0: SearchView.OnQueryTextListener?)

  @JavaMethod
  open func setOnQueryTextFocusChangeListener(_ arg0: ViewSwitcher.OnFocusChangeListener?)

  @JavaMethod
  open func setOnSuggestionListener(_ arg0: SearchView.OnSuggestionListener?)

  @JavaMethod
  open func setOnSearchClickListener(_ arg0: ViewSwitcher.OnClickListener?)

  @JavaMethod
  open func setIconifiedByDefault(_ arg0: Bool)

  @JavaMethod
  open func isIconfiedByDefault() -> Bool

  @JavaMethod
  open func isIconifiedByDefault() -> Bool

  @JavaMethod
  open func setSubmitButtonEnabled(_ arg0: Bool)

  @JavaMethod
  open func isSubmitButtonEnabled() -> Bool

  @JavaMethod
  open func setQueryRefinementEnabled(_ arg0: Bool)

  @JavaMethod
  open func isQueryRefinementEnabled() -> Bool

  @JavaMethod
  open func setSuggestionsAdapter(_ arg0: CursorAdapter?)

  @JavaMethod
  open func getSuggestionsAdapter() -> CursorAdapter!

  @JavaMethod
  open func onActionViewCollapsed()
  ...
  @JavaMethod
  open func setSearchableInfo(_ arg0: SearchableInfo?)

  @JavaMethod
  open func setOnCloseListener(_ arg0: SearchView.OnCloseListener?)

  @JavaMethod
  open func setQuery(_ arg0: CharSequence?, _ arg1: Bool)

  @JavaMethod
  open func setQueryHint(_ arg0: CharSequence?)

  @JavaMethod
  open func getQueryHint() -> CharSequence!

  @JavaMethod
  open func setIconified(_ arg0: Bool)

  @JavaMethod
  open func isIconified() -> Bool
...
extension JavaClass<SearchView> {
