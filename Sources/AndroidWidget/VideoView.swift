...
@JavaClass("android.widget.VideoView", implements: MediaController.MediaPlayerControl.self)
open class VideoView: JavaObject {
  @JavaMethod
  open func start()
  ...
  @JavaMethod
  open func resolveAdjustedSize(_ arg0: Int32, _ arg1: Int32) -> Int32

  @JavaMethod
  open func setAudioFocusRequest(_ arg0: Int32)

  @JavaMethod
  open func getBufferPercentage() -> Int32

  @JavaMethod
  open func onAttachedToWindow()

  @JavaMethod
  open func setVideoPath(_ arg0: String)

  @JavaMethod
  open func stopPlayback()

  @JavaMethod
  open func setMediaController(_ arg0: MediaController?)
  ...
  @JavaMethod
  open func seekTo(_ arg0: Int32)

  @JavaMethod
  open func isPlaying() -> Bool

  @JavaMethod
  open func canPause() -> Bool

  @JavaMethod
  open func canSeekBackward() -> Bool

  @JavaMethod
  open func canSeekForward() -> Bool
