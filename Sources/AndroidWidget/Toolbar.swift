...
@JavaClass("android.widget.Toolbar")
open class Toolbar: JavaObject {
  @JavaMethod
  ...
  @JavaMethod
  open func generateDefaultLayoutParams() -> Toolbar.LayoutParams!

  @JavaMethod
  open func generateLayoutParams(_ arg0: ViewSwitcher.LayoutParams?) -> Toolbar.LayoutParams!

  @JavaMethod
  open func setOnMenuItemClickListener(_ arg0: Toolbar.OnMenuItemClickListener?)

  @JavaMethod
  open func isOverflowMenuShowing() -> Bool

  @JavaMethod
  open func getTitleMarginStart() -> Int32

  @JavaMethod
  open func setTitleMarginStart(_ arg0: Int32)

  @JavaMethod
  open func getTitleMarginBottom() -> Int32

  @JavaMethod
  open func setTitleMarginBottom(_ arg0: Int32)

  @JavaMethod
  open func hasExpandedActionView() -> Bool

  @JavaMethod
  open func setSubtitleTextColor(_ arg0: Int32)

  @JavaMethod
  open func getNavigationContentDescription() -> CharSequence!

  @JavaMethod
  open func setNavigationContentDescription(_ arg0: CharSequence?)

  @JavaMethod
  open func setNavigationContentDescription(_ arg0: Int32)

  @JavaMethod
  open func setNavigationOnClickListener(_ arg0: ViewSwitcher.OnClickListener?)

  @JavaMethod
  open func getCollapseContentDescription() -> CharSequence!

  @JavaMethod
  open func setCollapseContentDescription(_ arg0: Int32)

  @JavaMethod
  open func setCollapseContentDescription(_ arg0: CharSequence?)

  @JavaMethod
  open func setContentInsetsRelative(_ arg0: Int32, _ arg1: Int32)

  @JavaMethod
  open func getContentInsetStart() -> Int32

  @JavaMethod
  open func setContentInsetsAbsolute(_ arg0: Int32, _ arg1: Int32)

  @JavaMethod
  open func getContentInsetLeft() -> Int32

  @JavaMethod
  open func getContentInsetRight() -> Int32

  @JavaMethod
  open func getContentInsetStartWithNavigation() -> Int32

  @JavaMethod
  open func setContentInsetStartWithNavigation(_ arg0: Int32)

  @JavaMethod
  open func getContentInsetEndWithActions() -> Int32

  @JavaMethod
  open func setContentInsetEndWithActions(_ arg0: Int32)

  @JavaMethod
  open func getCurrentContentInsetStart() -> Int32

  @JavaMethod
  open func getCurrentContentInsetEnd() -> Int32

  @JavaMethod
  open func getCurrentContentInsetLeft() -> Int32

  @JavaMethod
  open func getCurrentContentInsetRight() -> Int32

  @JavaMethod
  open func setTitleMargin(_ arg0: Int32, _ arg1: Int32, _ arg2: Int32, _ arg3: Int32)

  @JavaMethod
  open func getTitleMarginTop() -> Int32

  @JavaMethod
  open func setTitleMarginTop(_ arg0: Int32)

  @JavaMethod
  open func getTitleMarginEnd() -> Int32

  @JavaMethod
  open func setTitleMarginEnd(_ arg0: Int32)

  @JavaMethod
  open func setLogo(_ arg0: Int32)

  @JavaMethod
  open func setLogoDescription(_ arg0: Int32)

  @JavaMethod
  open func setLogoDescription(_ arg0: CharSequence?)

  @JavaMethod
  open func getLogoDescription() -> CharSequence!

  @JavaMethod
  open func collapseActionView()
  ...
  @JavaMethod
  open func setTitleTextColor(_ arg0: Int32)

  @JavaMethod
  open func setNavigationIcon(_ arg0: Int32)

  @JavaMethod
  open func setCollapseIcon(_ arg0: Int32)

  @JavaMethod
  open func inflateMenu(_ arg0: Int32)

  @JavaMethod
  open func getContentInsetEnd() -> Int32

  @JavaMethod
  open func setPopupTheme(_ arg0: Int32)

  @JavaMethod
  open func getPopupTheme() -> Int32

  @JavaMethod
  open func showOverflowMenu() -> Bool

  @JavaMethod
  open func hideOverflowMenu() -> Bool

  @JavaMethod
  open func dismissPopupMenus()
