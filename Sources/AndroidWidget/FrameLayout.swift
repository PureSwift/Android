...
open class FrameLayout: ViewGroup {
  ...
  @JavaMethod
  open override func setForegroundGravity(_ arg0: Int32)

  @JavaMethod
  open func generateDefaultLayoutParams() -> FrameLayout.LayoutParams!

  @JavaMethod
  open func setMeasureAllChildren(_ arg0: Bool)
  ...
  @JavaMethod
  open func getConsiderGoneChildrenWhenMeasuring() -> Bool
}
extension JavaClass<FrameLayout> {
