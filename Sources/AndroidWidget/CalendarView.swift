...
@JavaClass("android.widget.CalendarView")
open class CalendarView: FrameLayout {
  ...
  @JavaMethod
  open func setDate(_ arg0: Int64)

  @JavaMethod
  open func setDate(_ arg0: Int64, _ arg1: Bool, _ arg2: Bool)
  ...
  @JavaMethod
  open func setSelectedWeekBackgroundColor(_ arg0: Int32)

  @JavaMethod
  open func getSelectedWeekBackgroundColor() -> Int32

  @JavaMethod
  open func setFocusedMonthDateColor(_ arg0: Int32)

  @JavaMethod
  open func getFocusedMonthDateColor() -> Int32

  @JavaMethod
  open func setUnfocusedMonthDateColor(_ arg0: Int32)

  @JavaMethod
  open func getUnfocusedMonthDateColor() -> Int32

  @JavaMethod
  open func setWeekSeparatorLineColor(_ arg0: Int32)

  @JavaMethod
  open func getWeekSeparatorLineColor() -> Int32

  @JavaMethod
  open func setSelectedDateVerticalBar(_ arg0: Int32)

  @JavaMethod
  open func setWeekDayTextAppearance(_ arg0: Int32)

  @JavaMethod
  open func getWeekDayTextAppearance() -> Int32

  @JavaMethod
  open func setDateTextAppearance(_ arg0: Int32)

  @JavaMethod
  open func getDateTextAppearance() -> Int32

  @JavaMethod
  open func setOnDateChangeListener(_ arg0: CalendarView.OnDateChangeListener?)

  @JavaMethod
  open func setShownWeekCount(_ arg0: Int32)

  @JavaMethod
  open func getShownWeekCount() -> Int32

  @JavaMethod
  open func setWeekNumberColor(_ arg0: Int32)

  @JavaMethod
  open func getWeekNumberColor() -> Int32

  @JavaMethod
  open func getMinDate() -> Int64

  @JavaMethod
  open func setMinDate(_ arg0: Int64)

  @JavaMethod
  open func getMaxDate() -> Int64

  @JavaMethod
  open func setMaxDate(_ arg0: Int64)

  @JavaMethod
  open func setShowWeekNumber(_ arg0: Bool)

  @JavaMethod
  open func getShowWeekNumber() -> Bool
}
extension JavaClass<CalendarView> {
