...
@JavaClass("android.widget.AutoCompleteTextView", implements: Filter.FilterListener.self)
open class AutoCompleteTextView: EditText {
  @JavaMethod
  open func getFilter() -> Filter!

  @JavaMethod
  open func setThreshold(_ arg0: Int32)

  @JavaMethod
  open func getAdapter() -> ListAdapter!
  ...
  @JavaMethod
  open func getOnItemClickListener() -> AdapterView.OnItemClickListener!

  @JavaMethod
  open func setOnItemSelectedListener(_ arg0: AdapterView.OnItemSelectedListener?)

  @JavaMethod
  open func getOnItemSelectedListener() -> AdapterView.OnItemSelectedListener!

  @JavaMethod
  open override func getAccessibilityClassName() -> CharSequence!

  @JavaMethod
  open func setDropDownBackgroundResource(_ arg0: Int32)

  @JavaMethod
  open func getItemClickListener() -> AdapterView.OnItemClickListener!

  @JavaMethod
  open func getItemSelectedListener() -> AdapterView.OnItemSelectedListener!

  @JavaMethod
  open func refreshAutoCompleteResults()

  @JavaMethod
  open func convertSelectionToString(_ arg0: JavaObject?) -> CharSequence!

  @JavaMethod
  open func isPerformingCompletion() -> Bool

  @JavaMethod
  open func setOnDismissListener(_ arg0: AutoCompleteTextView.OnDismissListener?)

  @JavaMethod
  open func setDropDownVerticalOffset(_ arg0: Int32)

  @JavaMethod
  open func getDropDownVerticalOffset() -> Int32

  @JavaMethod
  open func setDropDownHorizontalOffset(_ arg0: Int32)

  @JavaMethod
  open func getDropDownHorizontalOffset() -> Int32

  @JavaMethod
  open func setCompletionHint(_ arg0: CharSequence?)

  @JavaMethod
  open func getCompletionHint() -> CharSequence!

  @JavaMethod
  open func getDropDownHeight() -> Int32

  @JavaMethod
  open func setDropDownHeight(_ arg0: Int32)

  @JavaMethod
  open func getDropDownAnchor() -> Int32

  @JavaMethod
  open func setDropDownAnchor(_ arg0: Int32)

  @JavaMethod
  open func getThreshold() -> Int32

  @JavaMethod
  open func enoughToFilter() -> Bool

  @JavaMethod
  open func isPopupShowing() -> Bool

  @JavaMethod
  open func setListSelection(_ arg0: Int32)

  @JavaMethod
  open func getListSelection() -> Int32

  @JavaMethod
  open func performCompletion()

  @JavaMethod
  open func replaceText(_ arg0: CharSequence?)

  @JavaMethod
  open func dismissDropDown()

  @JavaMethod
  open func showDropDown()

  @JavaMethod
  open func setValidator(_ arg0: AutoCompleteTextView.Validator?)

  @JavaMethod
  open func getValidator() -> AutoCompleteTextView.Validator!

  @JavaMethod
  open func performValidation()

  @JavaMethod
  open func setDropDownWidth(_ arg0: Int32)

  @JavaMethod
  open func getDropDownWidth() -> Int32
  ...
  @JavaMethod
  open func setText(_ arg0: CharSequence?, _ arg1: Bool)

  @JavaMethod
  open override func setFrame(_ arg0: Int32, _ arg1: Int32, _ arg2: Int32, _ arg3: Int32) -> Bool

  @JavaMethod
  open func performFiltering(_ arg0: CharSequence?, _ arg1: Int32)
...
extension JavaClass<AutoCompleteTextView> {
