...
@JavaClass("android.widget.HorizontalScrollView")
open class HorizontalScrollView: FrameLayout {
  ...
  @JavaMethod
  open func setRightEdgeEffectColor(_ arg0: Int32)

  @JavaMethod
  open func setLeftEdgeEffectColor(_ arg0: Int32)

  @JavaMethod
  open func getLeftEdgeEffectColor() -> Int32

  @JavaMethod
  open func getRightEdgeEffectColor() -> Int32

  @JavaMethod
  open func isSmoothScrollingEnabled() -> Bool

  @JavaMethod
  open func setSmoothScrollingEnabled(_ arg0: Bool)
  ...
  @JavaMethod
  open func setFillViewport(_ arg0: Bool)

  @JavaMethod
  open func pageScroll(_ arg0: Int32) -> Bool

  @JavaMethod
  open func fullScroll(_ arg0: Int32) -> Bool

  @JavaMethod
  open func arrowScroll(_ arg0: Int32) -> Bool

  @JavaMethod
  open func smoothScrollTo(_ arg0: Int32, _ arg1: Int32)
...
extension JavaClass<HorizontalScrollView> {
