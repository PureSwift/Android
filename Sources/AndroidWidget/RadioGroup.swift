...
@JavaClass("android.widget.RadioGroup")
open class RadioGroup: LinearLayout {
  @JavaMethod
  open func check(_ arg0: Int32)

  @JavaMethod
  open func getCheckedRadioButtonId() -> Int32

  @JavaMethod
  open func setOnCheckedChangeListener(_ arg0: RadioGroup.OnCheckedChangeListener?)
...
extension JavaClass<RadioGroup> {
