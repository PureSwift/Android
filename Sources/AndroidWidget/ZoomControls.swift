...
@JavaClass("android.widget.ZoomControls")
open class ZoomControls: LinearLayout {
  @JavaMethod
  open override func getAccessibilityClassName() -> CharSequence!

  @JavaMethod
  open func setOnZoomInClickListener(_ arg0: ViewSwitcher.OnClickListener?)

  @JavaMethod
  open func setOnZoomOutClickListener(_ arg0: ViewSwitcher.OnClickListener?)

  @JavaMethod
  open func setIsZoomOutEnabled(_ arg0: Bool)
  ...
  @JavaMethod
  open func setIsZoomInEnabled(_ arg0: Bool)
}
extension JavaClass<ZoomControls> {
