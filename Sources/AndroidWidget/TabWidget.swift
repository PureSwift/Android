...
open class TabWidget: LinearLayout {
  ...
  @JavaMethod
  open func setLeftStripDrawable(_ arg0: Int32)

  @JavaMethod
  open func setRightStripDrawable(_ arg0: Int32)

  @JavaMethod
  open func getTabCount() -> Int32

  @JavaMethod
  open func setStripEnabled(_ arg0: Bool)

  @JavaMethod
  open func isStripEnabled() -> Bool
