...
@JavaClass("android.widget.MultiAutoCompleteTextView")
open class MultiAutoCompleteTextView: AutoCompleteTextView {
  @JavaMethod
  open override func getAccessibilityClassName() -> CharSequence!

  @JavaMethod
  open override func enoughToFilter() -> Bool

  @JavaMethod
  open override func replaceText(_ arg0: CharSequence?)

  @JavaMethod
  open override func performValidation()

  @JavaMethod
  open override func performFiltering(_ arg0: CharSequence?, _ arg1: Int32)

  @JavaMethod
  open func performFiltering(_ arg0: CharSequence?, _ arg1: Int32, _ arg2: Int32, _ arg3: Int32)

  @JavaMethod
  open func setTokenizer(_ arg0: MultiAutoCompleteTextView.Tokenizer?)
}
extension JavaClass<MultiAutoCompleteTextView> {
