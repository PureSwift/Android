...
open class DatePicker: FrameLayout {
  ...
  @JavaMethod
  open func setOnDateChangedListener(_ arg0: DatePicker.OnDateChangedListener?)

  @JavaMethod
  open func getCalendarViewShown() -> Bool

  @JavaMethod
  open func setCalendarViewShown(_ arg0: Bool)

  @JavaMethod
  open func updateDate(_ arg0: Int32, _ arg1: Int32, _ arg2: Int32)

  @JavaMethod
  open func getCalendarView() -> CalendarView!

  @JavaMethod
  open func getSpinnersShown() -> Bool

  @JavaMethod
  open func setSpinnersShown(_ arg0: Bool)
