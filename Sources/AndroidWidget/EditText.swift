...
@JavaClass("android.widget.EditText")
open class EditText: TextView {
  @JavaMethod
  open override func getText() -> CharSequence!
  ...
  @JavaMethod
  open override func getDefaultEditable() -> Bool

  @JavaMethod
  open override func getFreezesText() -> Bool

  @JavaMethod
  open override func setText(_ arg0: CharSequence?, _ arg1: TextView.BufferType?)
}
extension JavaClass<EditText> {
