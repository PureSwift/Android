...
@JavaClass("android.widget.TableLayout")
open class TableLayout: LinearLayout {
  @JavaMethod
  open func setOnHierarchyChangeListener(_ arg0: ViewSwitcher.OnHierarchyChangeListener?)
  ...
  @JavaMethod
  open override func generateLayoutParams(_ arg0: ViewSwitcher.LayoutParams?) -> LinearLayout.LayoutParams!

  @JavaMethod
  open func setShrinkAllColumns(_ arg0: Bool)

  @JavaMethod
  open func isStretchAllColumns() -> Bool

  @JavaMethod
  open func setStretchAllColumns(_ arg0: Bool)

  @JavaMethod
  open func setColumnStretchable(_ arg0: Int32, _ arg1: Bool)

  @JavaMethod
  open func isColumnStretchable(_ arg0: Int32) -> Bool

  @JavaMethod
  open func setColumnShrinkable(_ arg0: Int32, _ arg1: Bool)

  @JavaMethod
  open func isShrinkAllColumns() -> Bool

  @JavaMethod
  open func setColumnCollapsed(_ arg0: Int32, _ arg1: Bool)

  @JavaMethod
  open func isColumnCollapsed(_ arg0: Int32) -> Bool
  ...
  @JavaMethod
  open override func checkLayoutParams(_ arg0: ViewSwitcher.LayoutParams?) -> Bool
}
extension JavaClass<TableLayout> {
