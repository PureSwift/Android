...
open class ListView: AbsListView {
  ...
  @JavaMethod
  open func getHeaderViewsCount() -> Int32

  @JavaMethod
  open func getFooterViewsCount() -> Int32
  ...
  @JavaMethod
  open func setSelectionAfterHeaderView()

  @JavaMethod
  open func setHeaderDividersEnabled(_ arg0: Bool)

  @JavaMethod
  open func areHeaderDividersEnabled() -> Bool

  @JavaMethod
  open func setFooterDividersEnabled(_ arg0: Bool)

  @JavaMethod
  open func areFooterDividersEnabled() -> Bool

  @JavaMethod
  open func getMaxScrollAmount() -> Int32

  @JavaMethod
  open override func layoutChildren()

  @JavaMethod
  open func setItemsCanFocus(_ arg0: Bool)

  @JavaMethod
  open func getItemsCanFocus() -> Bool

  @JavaMethod
  open override func setCacheColorHint(_ arg0: Int32)

  @JavaMethod
  open func getDividerHeight() -> Int32

  @JavaMethod
  open func setDividerHeight(_ arg0: Int32)

  @JavaMethod
  open func getCheckItemIds() -> [Int64]

  @JavaMethod
  open override func onSizeChanged(_ arg0: Int32, _ arg1: Int32, _ arg2: Int32, _ arg3: Int32)

  @JavaMethod
  open override func canAnimate() -> Bool
