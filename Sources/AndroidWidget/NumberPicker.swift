...
@JavaClass("android.widget.NumberPicker")
open class NumberPicker: LinearLayout {
  @JavaMethod
  open func getValue() -> Int32

  @JavaMethod
  open func setValue(_ arg0: Int32)
  ...
  @JavaMethod
  open func setOnValueChangedListener(_ arg0: NumberPicker.OnValueChangeListener?)

  @JavaMethod
  open func getWrapSelectorWheel() -> Bool

  @JavaMethod
  open func setWrapSelectorWheel(_ arg0: Bool)

  @JavaMethod
  open func setOnLongPressUpdateInterval(_ arg0: Int64)

  @JavaMethod
  open func setSelectionDividerHeight(_ arg0: Int32)
  ...
  @JavaMethod
  open func setMinValue(_ arg0: Int32)

  @JavaMethod
  open func getMaxValue() -> Int32

  @JavaMethod
  open func setMaxValue(_ arg0: Int32)

  @JavaMethod
  open func getDisplayedValues() -> [String]

  @JavaMethod
  open func setDisplayedValues(_ arg0: [String])
...
extension JavaClass<NumberPicker> {
