...
@JavaClass("android.widget.RelativeLayout")
open class RelativeLayout: JavaObject {
  @JavaMethod
  ...
  @JavaMethod
  open func setIgnoreGravity(_ arg0: Int32)

  @JavaMethod
  open func getIgnoreGravity() -> Int32

  @JavaMethod
  open func setVerticalGravity(_ arg0: Int32)
...
extension JavaClass<RelativeLayout> {
