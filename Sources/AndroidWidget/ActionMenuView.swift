...
open class ActionMenuView: LinearLayout {
  ...
  @JavaMethod
  open override func generateLayoutParams(_ arg0: ViewSwitcher.LayoutParams?) -> ActionMenuView.LayoutParams!

  @JavaMethod
  open func setOnMenuItemClickListener(_ arg0: ActionMenuView.OnMenuItemClickListener?)
...
extension JavaClass<ActionMenuView> {
