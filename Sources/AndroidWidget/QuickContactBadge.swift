...
@JavaClass("android.widget.QuickContactBadge", implements: ViewSwitcher.OnClickListener.self)
open class QuickContactBadge: ImageView {
  ...
  @JavaMethod
  open func setPrioritizedMimeType(_ arg0: String)

  @JavaMethod
  open func assignContactFromEmail(_ arg0: String, _ arg1: Bool)

  @JavaMethod
  open func assignContactFromPhone(_ arg0: String, _ arg1: Bool)
  ...
  @JavaMethod
  open func setImageToDefault()

  @JavaMethod
  open func setExcludeMimes(_ arg0: [String])
}
extension JavaClass<QuickContactBadge> {
