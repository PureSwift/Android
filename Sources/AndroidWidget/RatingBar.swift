...
@JavaClass("android.widget.RatingBar")
open class RatingBar: AbsSeekBar {
  @JavaMethod
  open override func getAccessibilityClassName() -> CharSequence!

  @JavaMethod
  open func setOnRatingBarChangeListener(_ arg0: RatingBar.OnRatingBarChangeListener?)

  @JavaMethod
  open func getOnRatingBarChangeListener() -> RatingBar.OnRatingBarChangeListener!

  @JavaMethod
  open func setIsIndicator(_ arg0: Bool)

  @JavaMethod
  open func isIndicator() -> Bool

  @JavaMethod
  open func setNumStars(_ arg0: Int32)

  @JavaMethod
  open func getNumStars() -> Int32

  @JavaMethod
  open func setRating(_ arg0: Float)

  @JavaMethod
  open func getRating() -> Float

  @JavaMethod
  open func setStepSize(_ arg0: Float)

  @JavaMethod
  open func getStepSize() -> Float

  @JavaMethod
  open override func setMax(_ arg0: Int32)

  @JavaMethod
  open override func onMeasure(_ arg0: Int32, _ arg1: Int32)
}
extension JavaClass<RatingBar> {
