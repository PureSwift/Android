...
open class TimePicker: FrameLayout {
  ...
  @JavaMethod
  open func setOnTimeChangedListener(_ arg0: TimePicker.OnTimeChangedListener?)
  ...
  @JavaMethod
  open func setHour(_ arg0: Int32)

  @JavaMethod
  open func setMinute(_ arg0: Int32)

  @JavaMethod
  open func setCurrentHour(_ arg0: JavaInteger?)

  @JavaMethod
  open func getCurrentHour() -> JavaInteger!

  @JavaMethod
  open func setCurrentMinute(_ arg0: JavaInteger?)

  @JavaMethod
  open func getCurrentMinute() -> JavaInteger!

  @JavaMethod
  open func setIs24HourView(_ arg0: JavaBoolean?)

  @JavaMethod
  open func is24HourView() -> Bool

  @JavaMethod
  open func validateInput() -> Bool
}
extension JavaClass<TimePicker> {
