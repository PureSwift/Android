...
open class AdapterViewFlipper: AdapterViewAnimator {
  ...
  @JavaMethod
  open override func fyiWillBeAdvancedByHostKThx()

  @JavaMethod
  open override func getAccessibilityClassName() -> CharSequence!

  @JavaMethod
  open func getFlipInterval() -> Int32

  @JavaMethod
  open func setFlipInterval(_ arg0: Int32)

  @JavaMethod
  open func startFlipping()

  @JavaMethod
  open func stopFlipping()

  @JavaMethod
  open func isFlipping() -> Bool

  @JavaMethod
  open func setAutoStart(_ arg0: Bool)
  ...
  @JavaMethod
  open override func showNext()

  @JavaMethod
  open override func showPrevious()
}
extension JavaClass<AdapterViewFlipper> {
