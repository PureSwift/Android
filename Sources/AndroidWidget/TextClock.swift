...
open class TextClock: TextView {
  ...
  @JavaMethod
  open func getFormat12Hour() -> CharSequence!

  @JavaMethod
  open func setFormat12Hour(_ arg0: CharSequence?)

  @JavaMethod
  open func getFormat24Hour() -> CharSequence!

  @JavaMethod
  open func setFormat24Hour(_ arg0: CharSequence?)

  @JavaMethod
  open func refreshTime()

  @JavaMethod
  open override func onAttachedToWindow()
}
extension JavaClass<TextClock> {
  @JavaStaticField(isFinal: true)
  public var DEFAULT_FORMAT_12_HOUR: CharSequence!

  @JavaStaticField(isFinal: true)
  public var DEFAULT_FORMAT_24_HOUR: CharSequence!
