...
open class LinearLayout: ViewGroup {
  ...
  @JavaMethod
  open func isMeasureWithLargestChildEnabled() -> Bool

  @JavaMethod
  open func setMeasureWithLargestChildEnabled(_ arg0: Bool)

  @JavaMethod
  open func getBaselineAlignedChildIndex() -> Int32
  ...
  @JavaMethod
  open func setShowDividers(_ arg0: Int32)

  @JavaMethod
  open func getShowDividers() -> Int32

  @JavaMethod
  open func setDividerPadding(_ arg0: Int32)

  @JavaMethod
  open func getDividerPadding() -> Int32

  @JavaMethod
  open func isBaselineAligned() -> Bool

  @JavaMethod
  open func setBaselineAligned(_ arg0: Bool)

  @JavaMethod
  open func getWeightSum() -> Float

  @JavaMethod
  open func setWeightSum(_ arg0: Float)
