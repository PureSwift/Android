...
@JavaClass("android.widget.inline.InlineContentView")
open class InlineContentView: JavaObject {
  @JavaMethod
  open func onDetachedFromWindow()

  @JavaMethod
  open func setSurfaceControlCallback(_ arg0: InlineContentView.SurfaceControlCallback?)

  @JavaMethod
  open func onAttachedToWindow()

  @JavaMethod
  open func isZOrderedOnTop() -> Bool

  @JavaMethod
  open func setZOrderedOnTop(_ arg0: Bool) -> Bool

  @JavaMethod
  open func onLayout(_ arg0: Bool, _ arg1: Int32, _ arg2: Int32, _ arg3: Int32, _ arg4: Int32)
}
extension JavaClass<InlineContentView> {
