...
@JavaClass("java.util.concurrent.ArrayBlockingQueue", implements: BlockingQueue<JavaObject>.self, Serializable.self)
open class ArrayBlockingQueue<E: AnyJavaObject>: AbstractQueue {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: Int32, _ arg1: Bool, _ arg2: JavaCollection<JavaObject>?, environment: JNIEnvironment? = nil)
  ...
  @JavaMethod
  open func put(_ arg0: JavaObject?) throws
  ...
  @JavaMethod
  open func offer(_ arg0: JavaObject?, _ arg1: Int64, _ arg2: TimeUnit?) throws -> Bool
