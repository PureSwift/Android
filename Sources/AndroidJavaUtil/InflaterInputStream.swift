...
@JavaClass("java.util.zip.InflaterInputStream")
open class InflaterInputStream: FilterInputStream {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: InputStream?, _ arg1: Inflater?, environment: JNIEnvironment? = nil)

  @JavaMethod
  @_nonoverride public convenience init(_ arg0: InputStream?, _ arg1: Inflater?, _ arg2: Int32, environment: JNIEnvironment? = nil)
