...
@JavaClass("java.util.concurrent.LinkedBlockingQueue", implements: BlockingQueue<JavaObject>.self, Serializable.self)
open class LinkedBlockingQueue<E: AnyJavaObject>: AbstractQueue {
  @JavaMethod
