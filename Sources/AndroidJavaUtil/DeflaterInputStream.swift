...
@JavaClass("java.util.zip.DeflaterInputStream")
open class DeflaterInputStream: FilterInputStream {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: InputStream?, _ arg1: Deflater?, environment: JNIEnvironment? = nil)

  @JavaMethod
  @_nonoverride public convenience init(_ arg0: InputStream?, environment: JNIEnvironment? = nil)

  @JavaMethod
  @_nonoverride public convenience init(_ arg0: InputStream?, _ arg1: Deflater?, _ arg2: Int32, environment: JNIEnvironment? = nil)
