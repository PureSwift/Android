...
open class Parcel: JavaObject {
  ...
  @JavaMethod
  open func readList(_ arg0: List<JavaObject>?, _ arg1: JavaClassLoader?, _ arg2: JavaClass<JavaObject>?)

  @JavaMethod
  open func readList(_ arg0: List<JavaObject>?, _ arg1: JavaClassLoader?)
