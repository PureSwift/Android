...
public extension AndroidX.Activity {
    
    /// `androidx.activity.ComponentActivity`
    typealias ComponentActivity = SwiftComponentActivity
}

/// `androidx.activity.ComponentActivity`
open class SwiftComponentActivity: AndroidContextWrapper {
    
    @_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_bind")
...
extension SwiftComponentActivity: JNIListener { }

// MARK: - Constants

public extension SwiftComponentActivity {
...
fileprivate extension SwiftComponentActivity {
    
    /// JNI Cache
    struct ActivityJNICache {
        
        static let classSignature = AndroidX.Activity.className(["ComponentActivity"]) // androidx.activity.ComponentActivity
    ...
    struct SwiftActivityJNICache {
        ...
        static let classSignature = SwiftSupport.App.className(["SwiftComponentActivity"])
...
public func SwiftComponentActivity_onCreate( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let activity = SwiftComponentActivity.swiftObject(from: __swiftObject)
    
    activity?.onCreate(savedInstanceState: bundle)
}

@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onStartNative")
public func SwiftComponentActivity_onStart( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                   _ __this: jobject?,
                                                   _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onResumeNative")
public func SwiftComponentActivity_onResume( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                    _ __this: jobject?,
                                                    _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onPauseNative")
public func SwiftComponentActivity_onPause( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                   _ __this: jobject?,
                                                   _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onRestartNative")
public func SwiftComponentActivity_onRestart( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                     _ __this: jobject?,
                                                     _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onStopNative")
public func SwiftComponentActivity_onStop( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                  _ __this: jobject?,
                                                  _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onDestroyNative")
public func SwiftComponentActivity_onDestroy( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                     _ __this: jobject?,
                                                     _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onBackPressed")
public func SwiftComponentActivity_onBackPressed( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                         _ __this: jobject?,
                                                         _ __swiftObject: jlong) -> () {
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onActivityResultNative")
public func SwiftComponentActivity_onActivityResultNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                                  _ __this: jobject?,
                                                                  _ __swiftObject: jlong,
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_onRequestPermissionsResultNative")
public func SwiftComponentActivity_onRequestPermissionsResultNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                                            _ __this: jobject?,
                                                                            _ __swiftObject: jlong,
                                                                            _ __requestCode: jint,
...
@_silgen_name("Java_org_pureswift_swiftandroidsupport_app_SwiftComponentActivity_finalizeNative")
public func SwiftComponentActivity_finalize( _ __env: UnsafeMutablePointer<JNIEnv?>,
                                                    _ __this: jobject?,
                                                    _ __swiftObject: jlong) -> () {
    
    SwiftComponentActivity.release(swiftObject: __swiftObject )
