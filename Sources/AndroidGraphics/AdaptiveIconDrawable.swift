...
@JavaClass("android.graphics.drawable.AdaptiveIconDrawable", implements: Drawable.Callback.self)
open class AdaptiveIconDrawable: Drawable {
  @JavaMethod
  @_nonoverride public convenience init(_ arg0: Drawable?, _ arg1: Drawable?, _ arg2: Drawable?, environment: JNIEnvironment? = nil)

  @JavaMethod
  @_nonoverride public convenience init(_ arg0: Drawable?, _ arg1: Drawable?, environment: JNIEnvironment? = nil)

  @JavaMethod
  open func getIconMask() -> AndroidGraphics.Path!
  ...
  @JavaMethod
  open func getMonochrome() -> Drawable!
...
extension JavaClass<AdaptiveIconDrawable> {
  @JavaStaticMethod
  public func getExtraInsetFraction() -> Float
}
